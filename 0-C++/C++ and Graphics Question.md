...
- [C++ and Graphics Questions](#c-and-graphics-questions)
  - [1-C++](#1-c)
    - [1-1 Basic 计算机基础](#1-1-basic-计算机基础)
      ...
      - [ Q9 位域](#-q9-位域)
      - [ 10 平时遇到野指针，该怎么排查](#-10-平时遇到野指针该怎么排查)
      - [ 11 数组指针和指针数组的区别](#-11-数组指针和指针数组的区别)
      - [ 12 \*A = nullptr 一定会报错吗 为什么](#-12-a--nullptr-一定会报错吗-为什么)
      - [ 13 Switch 要比 if else更快，为什么](#-13-switch-要比-if-else更快为什么)
...
#### <span style="color:#FFA07A;"> 10 平时遇到野指针，该怎么排查
...
#### <span style="color:#FFA07A;"> 11 数组指针和指针数组的区别
...
#### <span style="color:#FFA07A;"> 12 *A = nullptr 一定会报错吗 为什么
...
#### <span style="color:#FFA07A;"> 13 Switch 要比 if else更快，为什么
